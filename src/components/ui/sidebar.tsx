  ...
  return (
    <>
      <motion.div
        ...
        animate={{
          width: animate ? (open ? "225px" : "90px") : "300px",
        }}
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0bg-neutral-900 p-10 z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div
    ...
    >
      ...
      <>
        <motion.span
          ...
          className="text-black text-md group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
        >
          {link.label}
        </motion.span>
      </>
